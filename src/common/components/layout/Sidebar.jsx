...
import { LayoutDashboard, User, Briefcase, GraduationCap, FileText, LogOut, Github, X } from 'lucide-react';
  ...
  if (isMobile) {
    return (
      <>
        ...
        {/* Mobile Sidebar */}
        <div className={cn(
          "fixed left-0 top-0 h-screen w-80 bg-gradient-to-b from-slate-50 to-white border-r border-slate-200/60 flex flex-col shadow-xl backdrop-blur-sm z-50 transform transition-transform duration-300 ease-in-out md:hidden",
          ...
          {/* Logo Section */}
          <div className="px-6 pb-6 border-b border-slate-200/60 bg-white/80 backdrop-blur-sm">
